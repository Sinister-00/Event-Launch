    ...
    <main>
      ...
      <div
        className={cn(
          ...
          !firstRender ? "opacity-100" : "opacity-0"
        )}
      />
        ...
        <div className="flex flex-col items-center relative z-10">
          ...
          <p className="mb-8">
            <span className="text-gray-300">
              Join the community for the event held by{" "}
            </span>
            <Image
              alt="Event Logo"
          ...
          <div className="mb-8">
            <button
              className={cn(
                "text-black px-6 py-3 text-sm font-semibold rounded-md transition-colors duration-200",
                {
                  "bg-purple-300": currentFramework === "qwik",
                  "bg-sky-300": currentFramework === "safari",
                  "bg-yellow-300": currentFramework === "chrome",
